 ...
 */
$sImmobilienScout24Key    = 'ImmocasterKey';
$sImmobilienScout24Secret = 's4PrR@ujzUffm@9j-TfX';
 ...
 */
$oImmocaster->setDataStorage(array('mysql','localhost','root','root','php-sdk'));
...
{
	$aParameter = array('callback_url'=>'http://localhost:8888/php-sdk/test.php','verifyApplication'=>true);
